...
\imagen{ModeloGestionTFGTFM}{Proceso de gestión de TFG en la UBU.}{1}
...
\imagen{UBU-Chatbot}{UI del UBU-CHATBOT actual.}{0.5}
...
\imagen{UBU-Chatbot2}{Limitaciones del UBU-CHATBOT actual relativas a la formulación de preguntas por parte de los estudiantes.}{0.5}
